...
{
public:
    NotificationCardMoved(const QString& namePlayer, int idCard, ConstantesShared::EnumPacket packetOrigin, unsigned int indexCardOrigin, ConstantesShared::EnumPacket packetDestination, bool showCardToEveryone);
